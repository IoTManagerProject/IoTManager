...
#ifdef HAVE_ED25519
#if  defined(ED25519_SMALL) || defined(ESP8266_LOWMEM_FORCE_IMPL) /* use slower code that takes less memory */
...
#if !defined(ESP8266_LOWMEM_FORCE_IMPL)
...
#endif /* ESP8266_LOWMEM_FORCE_IMPL */
...
#ifdef ESP8266_LOWMEM_FORCE_IMPL
